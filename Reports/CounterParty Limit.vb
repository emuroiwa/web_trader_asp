...
Public Class CounterParty_Limit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.CounterParty Limit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCounterParty_Limit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CounterParty_Limit = New CounterParty_Limit()
        rpt.Site = Me.Site
        Return rpt
    End Function
