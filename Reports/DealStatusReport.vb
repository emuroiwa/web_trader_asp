...
Public Class DealStatusReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.DealStatusReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDealStatusReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DealStatusReport = New DealStatusReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
