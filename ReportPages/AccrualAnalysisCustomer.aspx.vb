...
Public Class AccrualAnalysisCustomer
    ...
    ByVal BookValue As Decimal, ByVal YTMBV As String, ByVal DailyAccrual As Decimal, ByVal WeekendAccrual As Decimal, ByVal usr As String)
        ...
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "SaveAccrualDetailsAssets")
        End Try
    ...
    Private Sub SaveAccrualDetailsLiabilities(ByVal dealDescription As String, ByVal dealReference As String, ByVal CustomerName As String, ByVal startDate As String, maturitydate As String, ByVal AmountInvested As Decimal, ByVal discRate As String, ByVal YTM As String, ByVal tenor As Integer, ByVal interestAmount As Decimal, ByVal DR As Integer, ByVal interestAccrued As Decimal, ByVal DTR As Integer, ByVal maturityValue As Decimal, ByVal DailyAccrual As Decimal, ByVal Curr As String, ByVal dealCode As String)
        ...
        Catch ex As SqlException
            MsgBox(ex.Message, MsgBoxStyle.Critical, "SaveAccrualDetailsLiabilities")
        End Try
    ...
    ByVal DailyAccrual As Decimal, ByVal WeekendAccrual As Decimal)
        ...
        Catch ex As SqlException
            MsgBox(ex.Message, MsgBoxStyle.Critical, "SaveSubTotalAssets")
        End Try
...
err:
        ...
        MsgBox(Err.Description, MsgBoxStyle.Critical, "LiabilitySummarySubTotal")
...
err:
        ...
        MsgBox(Err.Description, MsgBoxStyle.Critical, "AssetSummarySubTotal")
    ...
    ByVal InterestAccruals As Decimal, ByVal exchangeRate As Decimal)
        ...
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "saveLiabilitiesSummarySubTotals")
        End Try
   ...
   ByVal SubTotalDailyAccrual As Decimal)
        ...
        Catch ex As SqlException
            MsgBox(ex.Message, MsgBoxStyle.Critical, "SaveAccrualSummaryLiabilities")
        End Try
    ...
    ByVal discount As Decimal, ByVal IntAccrued As Decimal, ByVal exchangerate As Decimal)
        ...
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "saveSummaryAssetsSubTotals")
        End Try
    End Sub
    ...
    Private Sub ClearWorkTables()
        ...
        Catch ex As SqlException
            MsgBox(ex.Message, MsgBoxStyle.Critical, "ClearWorkTables")
        End Try
    End Sub
    Private Sub GetCurrency()
        ...
        Catch xr As Exception
            ...
            'Log the event *****************************************************
            object_userlog.SendDataToLog(Session("loggedUserLog") & "ERR001" & Format(Now, "dd/MM/yyyy hh:mm:ss") & xr.Message, Session("serverName"), Session("client"))
            '************************END****************************************
        End Try
    End Sub
    Private Function getProductDescription(ByVal code As String) As String
        ...
        Catch ex As SqlException
            MsgBox(ex.Message, MsgBoxStyle.Critical, "getProductDescription")
        End Try
    ...
    Private Sub clearNetTotals()
        ...
        Catch ex As SqlException
            MsgBox(ex.Message, MsgBoxStyle.Critical, "ClearNetTables")
        End Try
    End Sub
    Private Sub ConvertSummaryToBase()
        ...
        Catch ex As SqlException
            MsgBox(ex.Message, MsgBoxStyle.Critical, "ConvertSummaryToBase")
        End Try
    End Sub
    ...
    Private Sub NetTotals(ByVal curr As String)
        ...
        Catch ex As SqlException
            MsgBox(ex.Message, MsgBoxStyle.Critical, " Save the Net summary")
        End Try
