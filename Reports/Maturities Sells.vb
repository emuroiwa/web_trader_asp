...
Public Class Maturities_Sells
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Maturities Sells.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMaturities_Sells
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Maturities_Sells = New Maturities_Sells()
        rpt.Site = Me.Site
        Return rpt
    End Function
