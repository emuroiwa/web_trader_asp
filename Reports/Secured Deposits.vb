...
Public Class Secured_Deposits
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Secured Deposits.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSecured_Deposits
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Secured_Deposits = New Secured_Deposits()
        rpt.Site = Me.Site
        Return rpt
    End Function
