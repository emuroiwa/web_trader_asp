...
Public Class Bonds_Live_Sells
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Bonds Live Sells.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBonds_Live_Sells
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Bonds_Live_Sells = New Bonds_Live_Sells()
        rpt.Site = Me.Site
        Return rpt
    End Function
