<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="Loan.aspx.vb" Inherits="WEBTDS.frmMain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form1" runat="server">
        ...
        <ajaxToolkit:TabContainer ID="tabLoan" runat="server" ActiveTabIndex="1" Width="100%">
                                 ...
                                 <eo:grid ID="GridSecurity" runat="server" BorderColor="#C7D1DF" 
                                        ...
                                        <Columns>
                                            ...
                                            <eo:DeleteCommandColumn Name="Delete">
                                             ...
                                             <asp:TextBox ID="txtdealref" runat="server" AutoPostBack="true" Enabled="False"></asp:TextBox>
                                        </eo:CallbackPanel>
    ...
    <table style="width:100%;" >
                 ...
                 <td style="align-content:center;padding-bottom:10px">
                     <asp:Button ID="btnIntDays" runat="server" Text="Int Day Basis"  CssClass="btn btn-primary btn-block btn-flats" Height="40px" Width="150px" />
                        ...
                        <tr>                             
                  <td style="align-content:center ;padding-bottom:10px">
                      <asp:Button ID="btnSaveLoan" runat="server" CssClass="btn btn-primary btn-block btn-flats" Height="40px" Text="Deal" Width="150px" />
                            </td>
                        </tr>
                        <tr>      
                 <td style="align-content:center ;padding-bottom:10px">
                 ...
                 <td style="align-content:center;padding-bottom:10px">
                     &nbsp;</td>                            
                             ...
                             <asp:TextBox ID="TextBox1" runat="server" AutoPostBack="true" Enabled="False"  BorderStyle="None"  BackColor="White" ForeColor="White" BorderColor="White"></asp:TextBox>
                    </table>
                </ContentTemplate>
            </ajaxToolkit:TabPanel>
