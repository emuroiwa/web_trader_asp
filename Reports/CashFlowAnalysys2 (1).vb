...
Public Class CashFlowAnalysys2_1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CashFlowAnalysys2 (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.CashFlowAnalysys2 (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCashFlowAnalysys2_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CashFlowAnalysys2_1 = New CashFlowAnalysys2_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
