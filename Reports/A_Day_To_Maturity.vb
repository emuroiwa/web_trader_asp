...
Public Class A_Day_To_Maturity
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.A_Day_To_Maturity.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedA_Day_To_Maturity
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As A_Day_To_Maturity = New A_Day_To_Maturity()
        rpt.Site = Me.Site
        Return rpt
    End Function
