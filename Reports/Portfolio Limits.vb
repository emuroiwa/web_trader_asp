...
Public Class Portfolio_Limits
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Portfolio Limits.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPortfolio_Limits
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Portfolio_Limits = New Portfolio_Limits()
        rpt.Site = Me.Site
        Return rpt
    End Function
