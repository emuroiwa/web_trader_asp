...
Public Class TDS_deal_ref_vs_FCC_deal_ref
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "TDS deal ref vs FCC deal ref.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.TDS deal ref vs FCC deal ref.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTDS_deal_ref_vs_FCC_deal_ref
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TDS_deal_ref_vs_FCC_deal_ref = New TDS_deal_ref_vs_FCC_deal_ref()
        rpt.Site = Me.Site
        Return rpt
    End Function
