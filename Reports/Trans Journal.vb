...
Public Class Trans_Journal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Trans Journal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_dateProcessed() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTrans_Journal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Trans_Journal = New Trans_Journal()
        rpt.Site = Me.Site
        Return rpt
    End Function
