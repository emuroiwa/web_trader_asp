...
Public Class Deal_Slip_Loan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Slip Loan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeal_Slip_Loan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Slip_Loan = New Deal_Slip_Loan()
        rpt.Site = Me.Site
        Return rpt
    End Function
