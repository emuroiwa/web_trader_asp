...
Public Class Accruals_and_Maturity_Postings
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Accruals and Maturity Postings.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Accruals and Maturity Postings.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_postingDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAccruals_and_Maturity_Postings
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Accruals_and_Maturity_Postings = New Accruals_and_Maturity_Postings()
        rpt.Site = Me.Site
        Return rpt
    End Function
