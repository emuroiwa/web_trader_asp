...
Public Class Collateral_Items_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Collateral Items (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCollateral_Items_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Collateral_Items_1 = New Collateral_Items_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
