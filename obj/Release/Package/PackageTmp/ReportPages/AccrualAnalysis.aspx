<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="AccrualAnalysis.aspx.vb" Inherits="WEBTDS.AccrualAnalysis" %>
                      ...
                      <table style="width:60%;"><tr><td style="width:50%">
                          <table style="width:100%">
                              ...
                              <tr>
                                  ...
                                  Pick A Date<%--<input type="button" value = "Test the alert" onclick="alert('This is a custom alert dialog that was created by over-riding the window.alert method.');" /> --%>
                                  <td style="padding-bottom:10px">
...
<asp:DropDownList ID="cmbCurrency" runat="server" AutoPostBack="True" class="form-control select2" style="width: 100%;"></asp:DropDownList>
                          ...
                          <td style="width:50%">
                              ...
                              <table>
                                  <td style="padding-bottom:10px">
                                  <tr><td >  <asp:Button ID="btnLoad" runat="server" CssClass="btn btn-primary btn-block btn-flats" Height="40px" Text="Load Report" Width="150px" /></td></tr>
                                  <td style="padding-bottom:10px">
                                       <tr><td ><asp:Button ID="btnPrint" runat="server" CssClass="btn btn-primary btn-block btn-flats" Height="40px" Text="Print" Width="150px"  Enabled="false"/></td></tr>
              ...
              <div class="panel box box-success">
                            <div class="box-header with-border"><h4 class="box-title">
                                    ...
                                    <a data-toggle="collapse" data-parent="#accordion" href="#history12">Liabilities Detail view    Detail view   </a>
                                   </h4>                      </div>
                             <div id="history12" class="panel-collapse collapse">

                   
                      <table style="width:100%;" ><tr>
                          <td>
                              
                             <eo:grid ID="Grid2" runat="server" BorderColor="#C7D1DF" 
