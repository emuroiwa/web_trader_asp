...
Public Class Securities_by_Sales
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Securities by Sales.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Securities by Sales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSecurities_by_Sales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Securities_by_Sales = New Securities_by_Sales()
        rpt.Site = Me.Site
        Return rpt
    End Function
