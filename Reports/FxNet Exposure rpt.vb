...
Public Class FxNet_Exposure_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.FxNet Exposure rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFxNet_Exposure_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FxNet_Exposure_rpt = New FxNet_Exposure_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
