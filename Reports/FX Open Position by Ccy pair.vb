...
Public Class FX_Open_Position_by_Ccy_pair
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FX Open Position by Ccy pair.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.FX Open Position by Ccy pair.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFX_Open_Position_by_Ccy_pair
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FX_Open_Position_by_Ccy_pair = New FX_Open_Position_by_Ccy_pair()
        rpt.Site = Me.Site
        Return rpt
    End Function
