...
Public Class Deal_Slip_FXOption
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Slip FXOption.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeal_Slip_FXOption
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Slip_FXOption = New Deal_Slip_FXOption()
        rpt.Site = Me.Site
        Return rpt
    End Function
