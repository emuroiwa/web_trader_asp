...
Public Class Fx_Closing_Position_per_Dealer
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Fx Closing Position per Dealer.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Fx Closing Position per Dealer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFx_Closing_Position_per_Dealer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fx_Closing_Position_per_Dealer = New Fx_Closing_Position_per_Dealer()
        rpt.Site = Me.Site
        Return rpt
    End Function
