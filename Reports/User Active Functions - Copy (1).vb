...
Public Class User_Active_Functions___Copy_1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "User Active Functions - Copy (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.User Active Functions - Copy (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUser_Active_Functions___Copy_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As User_Active_Functions___Copy_1 = New User_Active_Functions___Copy_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
