...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="AddSecurityLocation.aspx.vb" Inherits="WEBTDS.AddSecurityLocation" %>
       ...
       <!-- Horizontal Form -->
         <asp:UpdatePanel ID="UpdatePanelAll" UpdateMode="Always" runat="server"><ContentTemplate>
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Security Location</h3> 
                          ...
                          <table style="width:100%;">
                              ...
                              <tr>
                                  <td style="width: 224px">
                                      <asp:Label ID="Label2" runat="server" Text="Location Description"></asp:Label>
                                  </td>
                              ...
                              <tr>
                                  <td style="width: 224px">
                                      <asp:Label ID="Label3" runat="server" Text="Location Address"></asp:Label>
                                  </td>
                                  <td style="width: 454px">
                                      <asp:TextBox ID="txtAddress" runat="server" Font-Size="Small" Height="63px" TextMode="MultiLine" Width="76%"></asp:TextBox>
                                  </td>
                                  <td>
        ...
        OnItemCommand="GrdLocation_ItemCommand" ClientSideOnContextMenu="ShowContextMenu">
                          ...
                          <Columns>
                              ...
                              <eo:StaticColumn HeaderText="ID" Width="300" DataField="locationID">
                              </eo:StaticColumn>
                              <eo:StaticColumn HeaderText="Description" Width="300" DataField="locationDescription">
                              </eo:StaticColumn>
                          </Columns>
                          <ColumnTemplates>
                              <eo:TextBoxColumn>
  ...
  Launch demo modal
     ...
     <script type="text/javascript">
        ...
        function OnContextMenuItemClicked(e, eventInfo) {
            var grid = eo_GetObject("<%=GrdLocation.ClientID%>");
