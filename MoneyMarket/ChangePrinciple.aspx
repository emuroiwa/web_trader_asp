...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="ChangePrinciple.aspx.vb" Inherits="WEBTDS.ChangePrinciple" %>
       ...
       <!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Change Principle</h3>  
                  ...
                  <div class="box-body">
                              ...
                              <ContentTemplate>
                                  <table style="width:100%;">
                                      <tr>
                                          <td>
                                              <asp:Label ID="Label51" runat="server" Text="AmendType"></asp:Label>
                                          </td>
                                           <td>
                                               <asp:RadioButtonList ID="RdAMendType" runat="server">
                                                   <asp:ListItem Value="Increase">Principle Increase</asp:ListItem>
                                                   <asp:ListItem Value=" Decrease">Principle Decrease</asp:ListItem>
                                               </asp:RadioButtonList>
                                          </td>
                                           <td></td>
                                      ...
                                      <tr>
                                          ...
                                          <td style="width: 398px">
                                              <asp:TextBox ID="dtMaturity" runat="server" Font-Size="Small" required="required" title="Please Enter Start Date" Width="75%" AutoPostBack="true" Enabled="False"></asp:TextBox>
                                      ...
                                      <tr>
                                          ...
                                          <td style="width: 398px">
                                              <asp:TextBox ID="txtTenor" runat="server" AutoPostBack="True" Font-Size="Small" min="1" type="number" Width="75%" Enabled="False" ></asp:TextBox>
                                          </td>
                                          <td style="align-content:center ;padding-bottom:10px">
                                       ...
                                       <tr>
                                          ...
                                          <td style="width: 398px">
                                              <asp:TextBox ID="txtPrincipalChange" runat="server" Font-Size="Small" required="required" style="margin-left: 0px" title="Please Enter Present value" Width="75%"></asp:TextBox>
                                              <br />
                                           </td>
                                          <td>
                                              <asp:Label ID="lblCustomerNumber" runat="server" Visible="False"></asp:Label>
                                           </td>
                                      </tr>
                                       <tr>
                                          <td style="width: 147px">
