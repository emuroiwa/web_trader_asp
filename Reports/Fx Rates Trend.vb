...
Public Class Fx_Rates_Trend
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Fx Rates Trend.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFx_Rates_Trend
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fx_Rates_Trend = New Fx_Rates_Trend()
        rpt.Site = Me.Site
        Return rpt
    End Function
