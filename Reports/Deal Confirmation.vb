...
Public Class Deal_Confirmation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Confirmation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeal_Confirmation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Confirmation = New Deal_Confirmation()
        rpt.Site = Me.Site
        Return rpt
    End Function
