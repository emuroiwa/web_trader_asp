...
Public Class TDS_System_Reports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.TDS System Reports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTDS_System_Reports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TDS_System_Reports = New TDS_System_Reports()
        rpt.Site = Me.Site
        Return rpt
    End Function
