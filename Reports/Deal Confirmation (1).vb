...
Public Class Deal_Confirmation_1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Deal Confirmation (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Confirmation (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeal_Confirmation_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Confirmation_1 = New Deal_Confirmation_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
