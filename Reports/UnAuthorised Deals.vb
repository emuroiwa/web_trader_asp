...
Public Class UnAuthorised_Deals
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.UnAuthorised Deals.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUnAuthorised_Deals
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UnAuthorised_Deals = New UnAuthorised_Deals()
        rpt.Site = Me.Site
        Return rpt
    End Function
