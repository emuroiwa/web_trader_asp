...
Public Class Fx_Rates_Trends
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Fx Rates Trends.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_loggedUser() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFx_Rates_Trends
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fx_Rates_Trends = New Fx_Rates_Trends()
        rpt.Site = Me.Site
        Return rpt
    End Function
