...
Public Class Pledged_Deposits
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Pledged Deposits.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPledged_Deposits
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pledged_Deposits = New Pledged_Deposits()
        rpt.Site = Me.Site
        Return rpt
    End Function
