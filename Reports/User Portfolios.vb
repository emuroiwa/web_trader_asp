...
Public Class User_Portfolios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.User Portfolios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUser_Portfolios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As User_Portfolios = New User_Portfolios()
        rpt.Site = Me.Site
        Return rpt
    End Function
