...
Public Class Deal_Slip_Forward_Rate_Agreement
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Deal Slip Forward Rate Agreement.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Slip Forward Rate Agreement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeal_Slip_Forward_Rate_Agreement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Slip_Forward_Rate_Agreement = New Deal_Slip_Forward_Rate_Agreement()
        rpt.Site = Me.Site
        Return rpt
    End Function
