...
Public Class Live_Deals_Summary_Dealer
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Live Deals Summary Dealer.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Live Deals Summary Dealer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLive_Deals_Summary_Dealer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Live_Deals_Summary_Dealer = New Live_Deals_Summary_Dealer()
        rpt.Site = Me.Site
        Return rpt
    End Function
