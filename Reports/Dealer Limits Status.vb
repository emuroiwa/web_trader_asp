...
Public Class Dealer_Limits_Status
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Dealer Limits Status.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Dealer Limits Status.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDealer_Limits_Status
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Dealer_Limits_Status = New Dealer_Limits_Status()
        rpt.Site = Me.Site
        Return rpt
    End Function
