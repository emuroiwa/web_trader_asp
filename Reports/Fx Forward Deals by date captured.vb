...
Public Class Fx_Forward_Deals_by_date_captured
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Fx Forward Deals by date captured.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Fx Forward Deals by date captured.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFx_Forward_Deals_by_date_captured
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fx_Forward_Deals_by_date_captured = New Fx_Forward_Deals_by_date_captured()
        rpt.Site = Me.Site
        Return rpt
    End Function
