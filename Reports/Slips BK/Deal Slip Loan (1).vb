...
Public Class Deal_Slip_Loan_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Slip Loan (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_recNumber() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDeal_Slip_Loan_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Slip_Loan_1 = New Deal_Slip_Loan_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
