...
Public Class Useractiv_Functions_1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Useractiv Functions (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Useractiv Functions (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUseractiv_Functions_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Useractiv_Functions_1 = New Useractiv_Functions_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
