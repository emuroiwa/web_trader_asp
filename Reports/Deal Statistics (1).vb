...
Public Class Deal_Statistics_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Statistics (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DateEnetered1() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DateEnetered2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDeal_Statistics_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Statistics_1 = New Deal_Statistics_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
