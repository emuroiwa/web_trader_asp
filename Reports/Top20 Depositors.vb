...
Public Class Top20_Depositors
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Top20 Depositors.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTop20_Depositors
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Top20_Depositors = New Top20_Depositors()
        rpt.Site = Me.Site
        Return rpt
    End Function
