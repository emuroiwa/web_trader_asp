...
Public Class Deal_Slip_FXSwitch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Slip FXSwitch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeal_Slip_FXSwitch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Slip_FXSwitch = New Deal_Slip_FXSwitch()
        rpt.Site = Me.Site
        Return rpt
    End Function
