...
Public Class Deal_Slip_Action_Sale_1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Deal Slip Action Sale (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Slip Action Sale (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeal_Slip_Action_Sale_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Slip_Action_Sale_1 = New Deal_Slip_Action_Sale_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
