...
Public Class Fx_Currency_Swap_Cash_flows
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Fx Currency Swap Cash flows.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Fx Currency Swap Cash flows.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFx_Currency_Swap_Cash_flows
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fx_Currency_Swap_Cash_flows = New Fx_Currency_Swap_Cash_flows()
        rpt.Site = Me.Site
        Return rpt
    End Function
