...
Public Class Bonds_all_by_customer
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Bonds all by customer.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Bonds all by customer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBonds_all_by_customer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Bonds_all_by_customer = New Bonds_all_by_customer()
        rpt.Site = Me.Site
        Return rpt
    End Function
