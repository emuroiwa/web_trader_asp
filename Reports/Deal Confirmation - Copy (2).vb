...
Public Class Deal_Confirmation___Copy_2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Deal Confirmation - Copy (2).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Confirmation - Copy (2).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_authID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDeal_Confirmation___Copy_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Confirmation___Copy_2 = New Deal_Confirmation___Copy_2()
        rpt.Site = Me.Site
        Return rpt
    End Function
