...
Public Class System_Messages
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.System Messages.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_System_Date() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSystem_Messages
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As System_Messages = New System_Messages()
        rpt.Site = Me.Site
        Return rpt
    End Function
