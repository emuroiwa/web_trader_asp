...
Public Class activeUserFunctions_1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "activeUserFunctions (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.activeUserFunctions (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedactiveUserFunctions_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As activeUserFunctions_1 = New activeUserFunctions_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
