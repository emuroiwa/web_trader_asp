...
Public Class Fx_Forward_deals_in_Period
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Fx Forward deals in Period.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Fx Forward deals in Period.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFx_Forward_deals_in_Period
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fx_Forward_deals_in_Period = New Fx_Forward_deals_in_Period()
        rpt.Site = Me.Site
        Return rpt
    End Function
