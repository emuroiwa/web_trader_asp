...
Public Class Deal_Slip_Purchase
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Deal Slip Purchase.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeal_Slip_Purchase
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deal_Slip_Purchase = New Deal_Slip_Purchase()
        rpt.Site = Me.Site
        Return rpt
    End Function
