<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="MaturedLoan.aspx.vb" Inherits="WEBTDS.MaturedLoan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <head runat="server" />
        ...
        <ajaxToolkit:TabContainer ID="tabMaturedLoan" runat="server" ActiveTabIndex="0" Width="100%">
                    ...
                    <table style="width:100%;">
                         ...
                         <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="cmbCustomerLoanM" runat="server" class="form-control select2" Width="80%" Font-Size="Small"  AutoPostBack="true">
                         ...
                         <tr>   
                            ...
                            <td>
                                <asp:TextBox ID="txtDealAccountLoan" runat="server" Enabled="False" Width="50%"></asp:TextBox>
                             </td>
                        ...
                        <tr>
                          ...
                          <button type="button" class="btn btn-warning"><asp:Label ID="txtIntDays" runat="server" Font-Bold="True"></asp:Label></button>
                                      </td>
                ...
                <fieldset title="Security">
                      ...
                      <div id="history" class="panel-collapse collapse-in">
                        ...
                        <button type="button" class="btn btn-success">Avg Rate <asp:Label ID="avgRate" runat="server" Text="Label"></asp:Label></button>     
                            ...
                            <button type="button" class="btn btn-success">Avg Tenor <asp:Label ID="avgTenor" runat="server"></asp:Label></button><hr />
  ...
  <eo:grid ID="GridClientHistory" runat="server" BorderColor="#C7D1DF" 
                              ...
                              <asp:Label ID="lblClientHistory" runat="server"></asp:Label>
                        </div>
                      </div>
                    </div> </ContentTemplate>
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="cmbCustomerLoanM" EventName="SelectedIndexChanged" />
            </Triggers>
        </asp:UpdatePanel>
            ...
            <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel2" ID="TabPanel2">
                ...
                <ContentTemplate>
                    <center><table style="width: 90%; height: 178px; table-layout: auto;">
                        <tr>
                            ...
                            <td style="width: 492px">
                                <asp:TextBox ID="StartDateLoan" runat="server" Width="75%"  required="required" title="Please Enter Start Date"></asp:TextBox>
                        ...
                        <td style="width: 369px; ">
                            <asp:TextBox ID="MaturityDateLoan" runat="server" Width="75%"  required="required" title="Please Enter Maturity Date"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td style="width: 492px">
                                <asp:TextBox ID="txtTenorLoan" runat="server"  type="number" min="1" Width="75%"></asp:TextBox>
                            </td>
                            <td style="width: 168px">
                        ...
                        <tr>
                            <td style="width: 291px; ">
                                &nbsp;</td>
                            <td style="width: 492px">
                                <asp:TextBox ID="txtTaxRateL" runat="server" Enabled="False" min="1" required="required" title="Please Enter Deal Tenor" type="number" Visible="False" Width="75%">0</asp:TextBox>
                            </td>
                            <td style="width: 168px">
                                <asp:Label ID="Label23" runat="server"  Text="Total Security"></asp:Label>
                            </td>
                            <td style="width: 369px">
                        ...
                        <tr>
                            ...
                            <td style="width: 168px">
                                <asp:Label ID="Label24" runat="server" Font-Size="Small" Text="Tax Amount" Visible="False"></asp:Label>
                            </td>
                            <td style="width: 369px">
                                <asp:TextBox ID="txtTaxAmountL" runat="server" Enabled="False" Width="75%" Visible="False"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                    ...
                    </table>  <div class="example-modal1 modal" id="AttachSecurity2">
    ...
    <table style="width:100%;" >
                 ...
                 <td style="align-content:center;padding-bottom:10px">
                     <asp:Button ID="btnIntDays" runat="server" Text="Int Day Basis"  CssClass="btn btn-primary btn-block btn-flats" Height="40px" Width="150px" />
                        ...
                        <tr>                             
                  <td style="align-content:center ;padding-bottom:10px">
                      <asp:Button ID="btnSaveMaturedLoan" runat="server" CssClass="btn btn-primary btn-block btn-flats" Height="40px" Text="Deal" Width="150px" />
                            </td>
                        </tr>
                        <tr>      
                 <td style="align-content:center ;padding-bottom:10px">
                     <asp:Button ID="btnReset" runat="server" CssClass="btn btn-primary btn-block btn-flats" Height="40px" Text="Reset" Width="150px" />
                        ...
                        <tr>                             
                  <td style="align-content:center;padding-bottom:10px">
                      <asp:Button ID="btnCancelLoan" runat="server" CssClass="btn btn-danger btn-block btn-flats" Height="40px" Text="Cancel Deal" Width="150px" />
                            </td>
                        </tr>
                        <tr>      
                 <td style="align-content:center ;padding-bottom:10px">
