...
Public Class Commission_Return
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Commission Return.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCommission_Return
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Commission_Return = New Commission_Return()
        rpt.Site = Me.Site
        Return rpt
    End Function
