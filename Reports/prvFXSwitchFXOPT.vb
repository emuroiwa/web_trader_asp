...
Public Class prvFXSwitchFXOPT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.prvFXSwitchFXOPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_refid() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedprvFXSwitchFXOPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As prvFXSwitchFXOPT = New prvFXSwitchFXOPT()
        rpt.Site = Me.Site
        Return rpt
    End Function
