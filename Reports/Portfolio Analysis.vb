...
Public Class Portfolio_Analysis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Portfolio Analysis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPortfolio_Analysis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Portfolio_Analysis = New Portfolio_Analysis()
        rpt.Site = Me.Site
        Return rpt
    End Function
