...
Public Class Fx_Currency_ladder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Fx Currency ladder.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Cur() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFx_Currency_ladder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fx_Currency_ladder = New Fx_Currency_ladder()
        rpt.Site = Me.Site
        Return rpt
    End Function
