...
Public Class Bonds_Live_purchases
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Bonds Live purchases.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Bonds Live purchases.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBonds_Live_purchases
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Bonds_Live_purchases = New Bonds_Live_purchases()
        rpt.Site = Me.Site
        Return rpt
    End Function
