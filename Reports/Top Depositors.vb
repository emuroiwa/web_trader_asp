...
Public Class Top_Depositors
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Top Depositors.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Deal_Date() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTop_Depositors
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Top_Depositors = New Top_Depositors()
        rpt.Site = Me.Site
        Return rpt
    End Function
