...
Public Class Fx_Forward_deals_in_Period_1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Fx Forward deals in Period (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEBTDS.Fx Forward deals in Period (1).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFx_Forward_deals_in_Period_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fx_Forward_deals_in_Period_1 = New Fx_Forward_deals_in_Period_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
